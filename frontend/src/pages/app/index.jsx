        ...
        <div className='pagina-cliente pagina'>
            ...
            <div className='serviços'>
                <section className="services-section">
                    <h2>Serviços</h2>
                    <p>
                    Transforme seu visual com nossos cuidados especializados. Aqui na Ale Barber, oferecemos uma experiência única, desde cortes clássicos até estilos modernos. Venha descobrir o seu estilo!
                    </p>
                </section>
